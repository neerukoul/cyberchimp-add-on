...
function cyberchimps_upsell_style() {
	...
	wp_enqueue_script( 'bootstrap-js', $directory_uri . 'bootstrap/js/bootstrap.min.js', array( 'jquery' ) );

	wp_enqueue_style( 'upsell_style', $directory_uri . 'css/upsell.css' );
}
					...
					<div id="upsell_header" class="span12">
						<h2>
							<a href="http://cyberchimps.com" target="_blank">
								<img src="<?php echo $directory_uri; ?>images/options/upsell-logo.png"/>
							</a>
						</h2>
							...
							<div id="<?php echo $theme->slug; ?>" class="theme-container span4 <?php echo $counter % 3 == 1 ? 'no-left-megin' : ""; ?>">
								...
								<div class="theme-details">
									...
									<?php if( wp_get_theme( $theme->slug )->exists() ) { ?>
										...
										<img data-toggle="tooltip" title="Already installed" data-placement="bottom" class="theme-exists" src="<?php echo $directory_uri ?>images/tick.png"/>
