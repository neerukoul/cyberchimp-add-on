...
function cyberchimps_add_core_fields( $fields_list ) {
    ...
    $imagepath = $directory_uri . '/images/';
    ...
    $fields_list[] = array(
        ...
        'type' => 'upload',
        'std' => apply_filters( 'cyberchimps_default_logo', $directory_uri . '/images/achimps.png' ),
        'section' => 'cyberchimps_header_options_section',
        'heading' => 'cyberchimps_header_heading'
    );
    ...
    if ( $theme_check == 'free' ):
        ...
        // Disable Boxes from homepage
        $fields_list[] = array(
            'name' => __( 'Disable Boxes', 'cyberchimps_core' ),
            'id' => 'cyberchimps_blog_boxes_lite_toggle',
            'std' => 'checked',
            'type' => 'toggle',
            'section' => 'cyberchimps_blog_boxes_lite_section',
            'heading' => 'cyberchimps_blog_heading'
        ...
        $fields_list[] = array(
            ...
            'type' => 'upload',
            'std' => get_template_directory_uri() . apply_filters( 'cyberchimps_boxes_lite_img1', '/elements/lib/images/boxes/slidericon.png' ),
            'section' => 'cyberchimps_blog_boxes_lite_section',
            'heading' => 'cyberchimps_blog_heading'
        );
        ...
        $fields_list[] = array(
            ...
            'type' => 'upload',
            'std' => get_template_directory_uri() . apply_filters( 'cyberchimps_boxes_lite_img2', '/elements/lib/images/boxes/blueprint.png' ),
            'section' => 'cyberchimps_blog_boxes_lite_section',
            'heading' => 'cyberchimps_blog_heading'
        );
        ...
        $fields_list[] = array(
            ...
            'type' => 'upload',
            'std' => get_template_directory_uri() . apply_filters( 'cyberchimps_boxes_lite_img3', '/elements/lib/images/boxes/docs.png' ),
            'section' => 'cyberchimps_blog_boxes_lite_section',
            'heading' => 'cyberchimps_blog_heading'
        );
        ...
        // Disable portfolio from homepage
        $fields_list[] = array(
            'name' => __( 'Disable Boxes', 'cyberchimps_core' ),
            'id' => 'cyberchimps_blog_portfolio_lite_toggle',
            'type' => 'toggle',
            'std' => 'checked',
            'section' => 'cyberchimps_blog_portfolio_lite_section',
            'heading' => 'cyberchimps_blog_heading'
        ...
        $fields_list[] = array(
            ...
            'type' => 'upload',
            'std' => $directory_uri . apply_filters( 'cyberchimps_portfolio_lite_img1', '/images/portfolio.jpg' ),
            'section' => 'cyberchimps_blog_portfolio_lite_section',
            'heading' => 'cyberchimps_blog_heading'
        );
        ...
        $fields_list[] = array(
            ...
            'type' => 'upload',
            'std' => $directory_uri . apply_filters( 'cyberchimps_portfolio_lite_img2', '/images/portfolio.jpg' ),
            'section' => 'cyberchimps_blog_portfolio_lite_section',
            'heading' => 'cyberchimps_blog_heading'
        );
        ...
        $fields_list[] = array(
            ...
            'type' => 'upload',
            'std' => $directory_uri . apply_filters( 'cyberchimps_portfolio_lite_img3', '/images/portfolio.jpg' ),
            'section' => 'cyberchimps_blog_portfolio_lite_section',
            'heading' => 'cyberchimps_blog_heading'
        );
        ...
        $fields_list[] = array(
            ...
            'type' => 'upload',
            'std' => $directory_uri . apply_filters( 'cyberchimps_portfolio_lite_img4', '/images/portfolio.jpg' ),
            'section' => 'cyberchimps_blog_portfolio_lite_section',
            'heading' => 'cyberchimps_blog_heading'
        );
...
// Disable slider from homepage
        $fields_list[] = array(
            'name' => __( 'Disable Boxes', 'cyberchimps_core' ),
            'id' => 'cyberchimps_blog_slider_lite_toggle',
            'type' => 'toggle',
            'std' => 'checked',
            'section' => 'cyberchimps_blog_slider_lite_section',
            'heading' => 'cyberchimps_blog_heading'
